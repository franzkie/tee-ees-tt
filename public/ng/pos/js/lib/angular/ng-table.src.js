...
//ty.. 3-29-14
        ...
        var iElm = angular.element(event.currentTarget);
        var defaultSort = $scope.params.settings().defaultSort;
        var inverseSort = (defaultSort === 'asc' ? 'desc' : 'asc');
//assuming defaultSort is always desc.
        var finalSort = inverseSort;//always asc if default is desc

        if(finalSort === 'asc' && iElm.hasClass('sort-desc') ) {
            finalSort = '';
        } else if(finalSort === 'asc' && iElm.hasClass('sort-asc') ){
            finalSort = 'desc';
        } else {
            finalSort = 'asc';
        }
        ...
        sortingParams[parsedSortable] = finalSort;//(sorting ? inverseSort : defaultSort);
 ...
 */
 ...
 //ty.. mar 22 global vars

/*gHeaderHTML = 'ng-table/header.html';
gPagerHTML = 'ng-table/pager.html';*/
var gHeaderHTML = '/ng/pos/templates/ng-table/header.html';
var gPagerHTML = '/ng/pos/templates/ng-table/pager.html';
            ...
            compile: function (element) {
                ...
                return function (scope, element, attrs) {
                    ...
                    if (!element.hasClass('ng-table')) {
                        scope.templates = {
                            header: (attrs.templateHeader ? attrs.templateHeader : gHeaderHTML),
                            pagination: (attrs.templatePagination ? attrs.templatePagination : gPagerHTML)
                        };
