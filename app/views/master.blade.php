...
<!-- class="wysihtml5-supported  pace-done fixed" style="min-height: 2014px;" -->
<body class="wysihtml5-supported pace-done skin-black fixed" style="min-height: 2014px;" >
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        <li><!-- start message -->
                                            <a href="#">
                                                <div class="pull-left">
                                                    ...
                                                    {{ HTML::image('img/avatar2.png', 'Smile', array('id' => 'smile' , 'class' => 'img-circle', 'alt' => 'User Image')) }}
                                                </div>
                                                <h4>
                                                    Support Team
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <!-- <img src="   {{ link_to_asset('img/avatar2.png')}}" class="img-circle" alt="user image"/> -->
                                            ...
                                            <a href="#">
                                                <div class="pull-left">
                                                    <!-- <img src="img/avatar.png" class="img-circle" alt="user image"/> -->
                                                       {{ HTML::image('img/avatar3.png', 'Smile', array('id' => 'smile' , 'class' => 'img-circle', 'alt' => 'User Image')) }}
                                                </div>
                                                <h4>
                                                    Reviewers
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li id="suppliers" class="{{Request::path() == 'Suppliers' ? 'active' : '';}}">
                            <a href="/suppliers">
